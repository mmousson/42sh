...
/*   Updated: 2019/06/11 13:05:20 by hben-yah         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int				compute_operation(char ***env, char *exp, t_arithast *ast,
																	long *res);
int				compute_division(char ***env, char *exp, t_arithast *ast,
																	long *res);
...
int				compute_logical(char ***env, char *exp, t_arithast *ast,
																	long *res);
int				compute_inverse(char ***env, char *exp, t_arithast *ast,
																	long *res);
...
t_arithtok		*token_new(char *val, size_t length, int type,
															t_arithtok *next);
