#!/bin/bash
printf "=== TESTING MISCELLANEOUS COMMANDS =========================================================\n"
bkp_pwd=`pwd`
cd misc
rm -f /tmp/misc_memory_report
rm -rf /tmp/outputs
...
for cmd in command_files/*; do
	...
	then
		...
		test -s /tmp/log && cat /tmp/log >> /tmp/misc_memory_report
	elif [ "$#" -eq 1 ]
	then
...
printf "\n=== END OF REPORT =========================================================================\n\n"
rm -rf emptyfile exec noexec noread notempty notfifo nowrite read write /tmp/expected_outputs /tmp/outputs file
cd $bkp_pwd
