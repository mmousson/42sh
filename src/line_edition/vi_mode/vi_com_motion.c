...
/*   Updated: 2019/04/27 13:47:07 by roliveir         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int			vi_spec_motion(char *str, int ret)
{
	if (str[0] == '^' && ret == 1)
		...
		vi_pipejump(g_env.mode->v_count);
	else if (str[0] == ';' && ret == 1)
		vi_repeat();
	else if (str[0] == ',' && ret == 1)
		vi_rev_repeat();
